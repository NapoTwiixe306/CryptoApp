import 'package:cryptoapp/data_json/card_json.dart';
import 'package:cryptoapp/data_json/card_operations_json.dart';
...
class _CardPageState extends State<CardPage> {
  ...
  getCard(amount, currency, cardNumber, validDate, bgColor) {
    var size = MediaQuery.of(context).size;
    return Column(
      children: [
        Row(
